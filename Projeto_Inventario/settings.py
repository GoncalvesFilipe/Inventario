"""
Django settings for Projeto_Inventario project.
...
SECRET_KEY = 'django-insecure-6evvmnz7)odq=we3+&+yt2yue*200)w^erk&!vwj&(o#da=6d+'
...
ROOT_URLCONF = 'Projeto_Inventario.urls'
...
WSGI_APPLICATION = 'Projeto_Inventario.wsgi.application'
